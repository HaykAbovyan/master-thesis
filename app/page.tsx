...
const REFERENCE_TEXT =
  "Աշակերտները դասարանում են։ Նրանք սովորում են հայոց լեզու։ Ուսուցչուհին գրատախտակին գրում է նոր բառեր։ Աշակերտները ուշադիր լսում են ուսուցչուհուն։ Պատուհանից երևում է դպրոցի բակը։ Այնտեղ մեծ ծառեր կան։ Զանգը հնչում է, և դասը ավարտվում է։ Երեխանեռը հավաքում են իրենց գրքերը։ Նրանք դուրս են գալիս դասարանից։ Բակում սկսում են խաղալ։ Արևը պայծառ շողում է։ Եղանակը տաք է և հաճելի։ Շուտոց կսկսվի հաջորդ դասը։";
